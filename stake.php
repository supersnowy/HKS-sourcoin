...
<head>
    ...
    <style>
        @charset "UTF-8";
        @import url(https://fonts.googleapis.com/css2?family=Kanit:wght@100;*,:after,:before{box-sizing:border-box;}@media (prefers-reduced-motion:no-preference) {
             :root {
                        ...
                        <div _ngcontent-ryl-c133="" class="container ng-tns-c133-1">
                            ...
                            <section _ngcontent-ryl-c133="" class="mt-3 ng-tns-c133-1" style="margin-bottom: 8rem;">
                                <div _ngcontent-ryl-c133="" class="wrapper ng-tns-c133-1">
                                    <div _ngcontent-ryl-c133="" class="row ng-tns-c133-1" style="display:flex;flex-direction: row;justify-content: center;">
                                        <div _ngcontent-ryl-c133="" class="promo-content col ng-tns-c133-1" style="height: 30rem; background-color: #ffffff; margin-top: 3rem; border-radius: 10px;text-align: center;padding: 1rem;">
                                            <p>
                                                <h5 _ngcontent-ryl-c133="" class="ng-tns-c133-1" style="color: #000000;">Farm</h5>
                                            </p>
                                            <p>
                                                <h2 _ngcontent-ryl-c133="" class="ng-tns-c133-1" style="color: #000000;">SOUR-BLOCKS LP Pool</h2>
                                            </p>
                                            <!--
                                        <p><h4 _ngcontent-ryl-c133="" class="ng-tns-c133-1" style="color: #333333;">APR: 384.53%<span style="width:50px;"><i class="fa fa-angle-left pull-right"></i></span></h4></p>
                                        -->
                                            <p _ngcontent-ryl-c133="" class="ng-tns-c133-1">Zapping SOUR automatically sells about half of SOUR for BLOCKS, adds both to the SOUR-BLOCKS pool, then stakes it to earn BLOCKS.</p>
                                            <div _ngcontent-ryl-c133="" class="d-flex top-button-container ng-tns-c133-1" style="justify-content: center;">
                                                <a _ngcontent-ryl-c133="" href="#" color="primary" class="mat-focus-indicator tg-btn ng-tns-c133-1 mat-raised-button mat-button-base mat-primary">
                                                    <span class="mat-button-wrapper">Zap SOUR</span><span class="mat-ripple mat-button-ripple"></span><span class="mat-button-focus-overlay"></span>
                                                </a>
                                                <input type="text" id="stake_amount" class="form-control" value="0" min="0" max="100000000000" style="width:60%;" />
                                            </div>
                                            <p _ngcontent-ryl-c133="" class="ng-tns-c133-1">Alternatively, create LP tokens manually from SOUR and BLOCKS</p>
                                            <div _ngcontent-ryl-c133="" class="d-flex top-button-container ng-tns-c133-1" style="justify-content: center;">
                                                <a id="btn_stake" _ngcontent-ryl-c133="" href="#" color="primary" class="mat-focus-indicator tg-btn ng-tns-c133-1 mat-raised-button mat-button-base mat-primary" style="margin: 0.5rem auto;">
                                                    <span class="mat-button-wrapper">Approve SOUR-BLOCKS to stake LP tokens directly</span><span class="mat-ripple mat-button-ripple"></span><span class="mat-button-focus-overlay"></span>
                                                </a>
                                            </div>
                                            <!--<br _ngcontent-ryl-c133="" class="ng-tns-c133-1" />-->

                                            <div _ngcontent-ryl-c133="" class="d-flex top-button-container ng-tns-c133-1" style="justify-content: center;">
                                                <a id="btn_unstake" _ngcontent-ryl-c133="" href="#" color="primary" class="mat-focus-indicator tg-btn ng-tns-c133-1 mat-raised-button mat-button-base mat-primary" style="margin: 0.5rem auto;">
                                                    <span class="mat-button-wrapper">Claim and withdraw all</span><span class="mat-ripple mat-button-ripple"></span><span class="mat-button-focus-overlay"></span>
                                                </a>
                                            </div>
                                            <!--
                                        <p><h5 _ngcontent-ryl-c133="" class="ng-tns-c133-1" style="color: #333333;">SOUR-BLOCKS rewards end in 02:03:11:57</h5></p>
                                        -->
                                        </div>
